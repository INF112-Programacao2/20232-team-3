...
public:
    ...
    static void add_user(const std::string& nomeArquivo, std::string username, std::string email, std::string password, int ID); // Entra no txt/json e adiciona um novo user;
